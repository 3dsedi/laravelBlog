      ...
      <div class="col-4 bg-white p-4 rounded">
        <form action="{{route('register')}}" method="POST">
          ...
          <div class="mb-4">
            ...
            class="bg-light border border-2 border-gray-100 w-100 p-4 rounded-lg @error('name')
          ...
          <div class="mb-4">
            ...
            class="bg-light border border-2 border-gray-100 w-100 p-4 rounded-lg @error('username')
          ...
          <div class="mb-4">
            ...
            class="bg-light border border-2 border-gray-100 w-100 p-4 rounded-lg @error('email')
          ...
          <div class="mb-4">
            ...
            class="bg-light border border-2 border-gray-100 w-100 p-4 rounded-lg @error('password')
          ...
          <div class="mb-4">
            ...
            class="bg-light border border-2 border-gray-100 w-100 p-4 rounded-lg @error('password_confirmation')
            border border-danger" @enderror value="">
          </div>
          <div>
